...
FROM MAIL_INFO
WHERE STATUS = &#39;N&#39;;</pre><div class="callout" style="margin-bottom:12px;background:#eff6ff;border-color:#60a5fa;"><p style="color:#1e40af;margin:0;font-size:0.9rem;"><strong>狀態語意：</strong><code>X</code> 是暫時作廢／排除，不是已發送；已發送狀態是 <code>Y</code>。必須先保存原始 ID 清單，測試後才能精準還原。 </p></div><pre style="background:#1e293b;color:#f1f5f9;border-radius:6px;padding:12px;font-size:0.82rem;line-height:1.65;margin-bottom:16px;">-- 步驟 1：先保存 CNT 與 ID_LIST
SELECT COUNT(*) AS CNT,
